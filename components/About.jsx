...
function About() {
  return (
    ...
    >
      ...
      >
        <div>
        Hello! I&apos;m Aryan Bhatia, a passionate full-stack web developer and problem-solver. Currently, I&apos;m freelancing, but I&apos;m actively seeking a full-time position as a Full-stack Developer. I thrive on challenges and possess proven project-based experience in MERN stack development. I also have hands-on experience in general development and have worked with AWS S3.
        ...
        <div className="w-fit break-words">
          <Link
            href="mailto:aryanbhatia9925@gmail.com"
            target="_blank"
            rel="noreferrer"
        ...
        <Link
          href="document/Aryan_ScaledSolution (2).pdf"
          target="_blank"
          rel="noreferrer"
          className="w-fit"
        >
